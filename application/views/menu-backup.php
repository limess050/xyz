<ul id="menu">
    <li><a href="#" >Home</a></li>
    <li><a href="tanzania-business-directory" class="drop">Business Directory</a><!-- Begin Home Item -->
...
<!--             <?php if($first != 8): ?>
          ...
          <div class="col_2">
                ...
                <p class="black_box">
                    <img src = "images/sitewide/btns-01.png" height=90 width=250 class = "center_image" />

                    Procurement made easy! Learn how to request a quote from up to 6 business at one time > <a href = "">Click Here</a>
                    </p>
                <p class="black_box">
                    <img src = "images/sitewide/btns-06.png" height=90 width=250  class = "center_image"/>
