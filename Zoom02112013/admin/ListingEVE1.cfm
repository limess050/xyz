...
function clearRepeats(){
	...
	var obj = document.getElementById('RecurrenceDayID');
	
	if(document.f1.RecurrenceID.selectedIndex != 3)
		document.f1.RecurrenceMonthID.selectedIndex = 0;
	
	if(document.f1.RecurrenceID.selectedIndex != 1 && document.f1.RecurrenceID.selectedIndex != 2){
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<lh:MS_TableColumn
		...
		Search="false"
		ShowOnEdit="true" /><lh:MS_TableColumn
	...
	<lh:MS_TableColumn
		ColName="Title"
		DispName="Event Title"
		type="text" 
		MaxLength="200"
		Required="Yes" />
		
	<lh:MS_TableColumn
		ColName="EventStartDate"
		DispName="Event Start Date"
		ShowDate="Yes"
		ShowTime="Yes" 
		type="Date"
		Required="Yes"
	...
	<lh:MS_TableColumn
		ColName="EventEndDate"
		DispName="Event End Date"
		ShowDate="Yes"
		ShowTime="Yes" 
		type="Date"
		Required="No"
	...
	<lh:MS_TableColumn
		ColName="RecurrenceID"
		DispName="Repeats?"
		type="select"
		formfieldparameters="onchange=""clearRepeats()"""	
		FKTable="Recurrences"
		FKColName="RecurrenceID"
		FKDescr="Descr" 
		required="no"
		SelectQuery="Select RecurrenceID as SelectValue, Descr as SelectText From Recurrences Order By RecurrenceID"
		view="no"		/>	
	
	<lh:MS_TableColumn
		ColName="RecurrenceDayID"
		DispName="Repeats Weekly or Bi-Weekly On"
		type="select-multiple"
		FKTable="RecurrenceDays"
		FKColName="RecurrenceDayID"
		FKDescr="Descr"
		FKJoinTable="ListingRecurrences"
		SelectQuery="Select RecurrenceDayID as SelectValue, Descr as SelectText From RecurrenceDays Order By RecurrenceDayID"
		Required="No" />	
		
	<lh:MS_TableColumn
		ColName="RecurrenceMonthID"
		DispName="Repeats Monthly On"
		type="select"
		FKTable="RecurrenceMonths"
		FKColName="RecurrenceMonthID"
		FKDescr="Descr" 
		SelectQuery="Select RecurrenceMonthID as SelectValue, Replace(Descr,'5th','Last') as SelectText From RecurrenceMonths Order By RecurrenceMonthID"	
		required="no"
		view="no"		/>	
	...
	<lh:MS_TableColumn
		ColName="LocationOther"
		DispName="Location - Other"
		type="text" 
		MaxLength="200" />	
