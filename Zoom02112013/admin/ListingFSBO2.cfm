...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<lh:MS_TableColumn 
		colname="FourWheelDrive" 
		DispName="Four Wheel Drive"
		type="checkbox" 
		OnValue="1" 
		Offvalue="0"
		DefaultValue="0" />
	...
	<lh:MS_TableColumn
		ColName="TransmissionID"
		DispName="Transmission"
		type="select"
		FKTable="Transmissions"
		FKColName="TransmissionID"
		FKDescr="Title" />	
...
<script language="javascript" type="text/javascript">
	...
	{		    
		var LocSL= $("##LocationID_TR").html();
		var newLocSL = LocSL.replace("multiple","");
		$("##LocationID_TR").html(newLocSL);
		$("##LocationID").attr("size",1);
	});
