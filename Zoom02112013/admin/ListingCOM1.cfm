...
<cfquery name="checkForPriceRangeCategories" datasource="#Request.dsn#" username="#Request.dbusername#" password="#Request.dbpassword#">
	Select CategoryID
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<cfif ListFind("157",checkForPriceRangeCategories.CategoryID)>		
		<lh:MS_TableColumn
			ColName="NGOTypeID"
			DispName="NGO Types"
			type="select-multiple"
			FKJoinTable="ListingNGOTypes"
			FKOrderBy="OrderNum"
			FKTable="NGOTypes"
			FKColName="NGOTypeID"
			FKDescr="Title"
		...
		<lh:MS_TableColumn
			ColName="NGOTypeOther"
			DispName="NGO Type (Other)"
			type="text" 
			MaxLength="200" />	
	</cfif>
