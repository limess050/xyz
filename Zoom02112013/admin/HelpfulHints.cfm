...
<lh:MS_Table table="Hints" title="#pg_title#" >
	...
	<lh:MS_TableColumn
		...
		FKDescr="Title"
		FKJoinTable="HintParentSections"
...
<cfif IsDefined('Action') and ListFind("Add,Edit",Action)>
	...
	<cfquery name="getSelectedParentSections" datasource="#Request.dsn#" username="#Request.dbusername#" password="#Request.dbpassword#">
		...
		FROM HintParentSections 
		WHERE HintID = <cfif Action is "Add">0<cfelse><cfqueryparam value="#pk#" cfsqltype="CF_SQL_INTEGER"></cfif> 
	</cfquery>
