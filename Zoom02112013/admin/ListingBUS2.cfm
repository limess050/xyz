...
<cfset pg_title = "Restaurant Listing">
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<lh:MS_TableColumn
		ColName="CuisineOther"
		DispName="Cuisine (Other)"
		type="text" 
		MaxLength="200" />
	
	<lh:MS_TableColumn
		ColName="TextMenu"
		DispName="Text-based Menu"
		type="textarea"
		allowHTML="No"
		SpellCheck="Yes"
		View="No" />	
