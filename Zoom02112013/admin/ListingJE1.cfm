...
<cfset ListingUploadedDocsDir = "">
<cfif Request.environment is "DB">
	<cfset ListingUploadedDocsDir = ListingUploadedDocsDir & "DAR\Web\">
</cfif>
<cfset ListingUploadedDocsDir = ListingUploadedDocsDir & "ListingUploadedDocs">
<!--- <cfoutput>#ListingUploadedDocsDir#</cfoutput> --->
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<lh:MS_TableColumn
		...
		DispName="Application Instructions"
		type="textarea"
		allowHTML="No"
		SpellCheck="Yes"
		View="No" />
	...
	<lh:MS_TableColumn
		ColName="UploadedDoc"
		DispName="Position Description Document"
		type="File"
		Directory="#ListingUploadedDocsDir#"
...
<cfif Action is "Edit">
	<cfquery name="q2" datasource="#Request.dsn#" username="#Request.dbusername#" password="#Request.dbpassword#">
		...
		(Select Top 1 IsNull(Us.FirstName,'') + ' ' + IsNull(Us.LastName,'') From Updates Up Left Outer Join LH_Users Us on Up.UpdatedByID=Us.UserID Where ListingID=L.ListingID Order by UpdateDate Desc) as UpdatedBy
		From Listings L
