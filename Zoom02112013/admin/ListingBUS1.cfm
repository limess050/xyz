...
<cfset pg_title = "Business Listing">
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<cfif ListFind(Request.PriceRangeCategoryIDs,checkCategories.CategoryID)>
		<lh:MS_TableColumn
			ColName="PriceRangeID"
			DispName="Price Ranges"
			type="select-multiple"
			FKJoinTable="ListingPriceRanges"
			FKOrderBy="OrderNum"
			FKTable="PriceRanges"
			FKColName="PriceRangeID"
			FKDescr="Title"
			Required="yes" />	
	</cfif>
	
	<cfif ListFind(Request.ParkCategoryIDs,checkCategories.CategoryID)>
		<lh:MS_TableColumn
			ColName="ParkID"
			DispName="Parks"
			type="select-multiple"
			FKJoinTable="ListingParks"
			FKOrderBy="OrderNum"
			FKTable="Parks"
			FKColName="ParkID"
			FKDescr="Title" />	
