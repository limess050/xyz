...
<cfset pg_title = "Movie Theater Listing">
...
<cfquery name="checkCategories" datasource="#Request.dsn#" username="#Request.dbusername#" password="#Request.dbpassword#">
	Select CategoryID
...
<cfif Request.environment is "DB">
	<cfset ListingDocsDir = ListingDocsDir & "Zoom\Web\">
</cfif>
<cfset ListingDocsDir = ListingDocsDir & "ListingUploadedDocs">

<p id="PhoneOnlyWarning" style="display:none;" class="Important"></p>
...
<lh:MS_Table table="#ListingTable#" title="#pg_title#"
	...
	<lh:MS_TableColumn
		ColName="Title"
		DispName="Business Name"
		type="text" 
		Validate="checkListingTitleIsUnique()"
		MaxLength="200"
		Required="Yes" />
	...
	<lh:MS_TableColumn
		...
		type="pseudo"
		Expression="'#Request.HTTPURL#/' + URLSafeTitle" 
		Search="false"
		ShowOnEdit="true" />
	...
	<lh:MS_TableChild 
		...
		<lh:MS_TableColumn
			ColName="NowPlayingID"
			DispName="Now Playing?"
			type="select"
			Required="Yes"
			FKTable="NowPlayings"
			FKDescr="Title"
		...
		<lh:MS_TableColumn
			ColName="DailyShowTimes"
			DispName="Daily Show Times"
			type="text" />
		
		<lh:MS_TableColumn
			ColName="OtherShowTimes"
			DispName="Other Show Times"
			type="text" />
	...
	<lh:MS_TableColumn
		ColName="PublicPhone2"
		DispName="Fax"
		type="text" 
		MaxLength="20" />
		
	<lh:MS_TableColumn
		ColName="PublicPhone3"
		DispName="Other Public Phone"
		type="text" 
		MaxLength="20" />
		
	<lh:MS_TableColumn
		ColName="PublicPhone4"
		DispName="Other Public Phone"
		type="text" 
		MaxLength="20" />
...
<script language="javascript" type="text/javascript">
	...
	{		    
		...
		<cfif Action is "Edit">
			...
			<cfif q2.PhoneOnlyListing_fl>
				$("##PhoneOnlyWarning").html('This is a Phone Only Listing');
				$("##PhoneOnlyWarning").show();
			</cfif>
...
<cfif Action is "Edit">
	...
	<script>
		function checkListingTitleIsUnique() {
			var allowTitle;
			var datastring = "ListingTitle=" + encodeURIComponent(document.f1.Title.value)  + "&PK=#PK#";
			$.ajax(
	           {
				type:"POST",	
				async: false, // this makes the ajax-call blocking								
	               url:"#Request.HTTPSURL#/includes/CheckListingTitle.cfc?method=CheckTitle&returnformat=plain",
	               data:datastring,
	               success: function(response)
	               {
