...
<cfquery name="getListing" datasource="#Request.dsn#" username="#Request.dbusername#" password="#request.dbpassword#">
	Select L.ListingID, 
	L.ListingTitle, 
	L.ListingTypeID, L.ListingType,
	LC.CategoryID, C.Title as Category, C.URLSafeTitle as CategoryURLSafeTitle,
...
<cfif getListing.RecordCount>
	<cfif not ListFind("1,2,14,15",getListing.ListingTypeID) and getListing.ListingExpired and not Preview>
		<cfoutput>
			...
			<p>The listing you are attempting to view is expired. Please see other listings like it&nbsp;in&nbsp;>&nbsp;<a href="<cfif AmpOrQuestion is "?">#getListing.CategoryURLSafeTitle#<cfelse>#lh_getPageLink(2,'category')##AmpOrQuestion#CategoryID=#GetListing.CategoryID#</cfif>">#getListing.Category#</a>.
		</cfoutput>
	<cfelse>
		...
		<div class="TB_Wrapper">
			<div class="Slides">
				<cfoutput query="getListingImages">					
					<div class="Slide">
						<img src="ListingImages/#listDeleteAt(FileName,listLen(FileName,"."),".")#FS.#ListLast(FileName,".")#" alt="#ListingTitleForH1# Image #CurrentRow#" />
					</div>
					<cfif getListingImages.RecordCount is "1">
						<div class="Slide">
							<img src="ListingImages/#listDeleteAt(FileName,listLen(FileName,"."),".")#FS.#ListLast(FileName,".")#" alt="#ListingTitleForH1# Image #CurrentRow#" />
						</div>
					</cfif>
